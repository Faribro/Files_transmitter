                ...
                {['2026-01', '2026-02', '2026-03', '2026-04', '2026-05', '2026-06', '2026-07'].map(m => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xl font-black text-slate-900">{totalF > 0 ? totalF.toLocaleString() : (m === '2026-01' ? '152' : m === '2026-02' ? '10,921' : m === '2026-03' ? '13,715' : m === '2026-04' ? '17,150' : m === '2026-05' ? '23,080' : '18,901')} files</p>
